...
- (void)pushTopViewController:(UIViewController *)newViewController {
    ...
    NSLog(@"destination rect %@", NSStringFromCGRect(destinationRect));
    NSLog(@"container view rect %@", NSStringFromCGRect(self.containerView.topView.frame));
    ...
    [self transitionFromViewController:top toViewController:newViewController duration:2 options:UIViewAnimationOptionCurveEaseIn
                                animations:^{ 
